        ...
        <div class="settings-body">
          ...
          <div class="settings-content">
            ...
            <div v-if="activeCategory === 'autocomplete'" class="settings-section">
              ...
              <div class="setting-item">
                <div class="setting-info">
                  <label class="setting-label">{{ t('settings.items.ignoreAtPrefix') }}</label>
                  <p class="setting-desc">{{ t('settings.items.ignoreAtPrefixDesc') }}</p>
                </div>
                <label class="switch">
                  <input type="checkbox" v-model="settings.ignoreAtPrefixForRecognition">
                  <span class="slider"></span>
                </label>
              </div>
            </div>
